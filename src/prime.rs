...
macro_rules! ntt_prime_impl {
    ( $alias:ident, $p:expr, $r:expr) => {
        pub type $alias = Prime<$p>;
...
ntt_prime_impl!(P23a, 998_244_353, 3);
...
// `(a << 27) + 1`
ntt_prime_impl!(P27a, 2_013_265_921, 31);
ntt_prime_impl!(P27b, 2_281_701_377, 3);
ntt_prime_impl!(P27c, 3_892_314_113, 3);
// `(a << 28) + 1`
ntt_prime_impl!(P28a, 3_489_660_929, 3);
// `(a << 39) + 1`
ntt_prime_impl!(P30a, 3_221_225_473, 5);
